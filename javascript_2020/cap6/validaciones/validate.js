...
const validateEmail = async (email) => {
    ...
    else return false; // console.log('email incorrecto')
}



const testEmail = async (email) => {
    let isValidMail = await validateEmail(email);
    console.log(`isValidMail ${isValidMail}`)
}

validateEmail("felix@da.co").then(res => console.log(res));

testEmail("asdasd@inf.cl");